...
def test_mala_kernel():
    ...
    dt = 0.1
    position, log_prob, do_accept = mala_kernel(rng_key, logpdf, d_logpdf, position, log_prob, dt)
...
def test_rw_metropolis_kernel():
    ...
    log_prob = logpdf(position)
    dt = 0.1
    position, log_prob, do_accept = rw_metropolis_kernel(rng_key, logpdf, d_logpdf, position, log_prob, dt)