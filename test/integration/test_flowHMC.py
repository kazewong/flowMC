...
# flowHMC_sampler.precompilation(n_chains, n_dim, n_local_steps, data)
...
# flowHMC_sampler.update_vmap(1, state)

# state = flowHMC_sampler.sample(rng_key_set[1], n_local_steps, initial_position[:, 0], data)
